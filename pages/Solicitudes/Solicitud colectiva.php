        ...
        <div class="col">
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input name="nombre_comite" type="text" class="form-control" id="comite-nombre" placeholder required>
                </div>
    
                <div class="form-group">
                    <label for="">Detalles del comité</label>
                    <textarea name="descripcion" id="comite-detalles" cols="30" rows="5" class="form-control" required></textarea>
                </div>
    ...
    $(document).ready(function(){
        ...
        $('#formulario-solicitud').submit(function(e){
            ...
            if (listaIntegrantesComite.length > 0) {
                ...
                $.ajax({
                    url : 'pages/Formularios/insertar_solicitud_colectiva.php',
                    method : "POST",
                    data : datosEnviar,
                    error: function() {
                    ...
                    success: function(data) {
                        ...
                        window.location.href = "index.php?page=Formato-imprimible-colectivo&accion=Insertar&idSolicitud=" + id;
                    }
                });
                ...
                Swal.fire({
                    title: '',
                    text: 'Seleccionar o registar al menos un integrante del comité.',
                    icon: 'warning',
