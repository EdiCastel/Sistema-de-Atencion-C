<?php
    ...
    from ciudadanos c where id_ciudadano = :id_ciudadano";
...
<h1 class="text-dark">Detalles de solicitud individual</h1>
  ...
  <div class="container p-5">
    ...
    <?php if ($evidencias > 0 ) { ?>                
        ...
        <div class="form-group d-flex justify-content-center"> 
            ...
            <a class="btn btn-danger mr-4 w-25 text-white" href="index.php?page=Detalles-solicitud-individual&id=<?= $_GET['id']; ?>&id_estado_solicitud=<?=$row['id_estado_solicitud']?>&evidencias=0">
                    ...
                    <div class="col-7">
                        ...
                        <form action="services/carga_evidencia.php" enctype="multipart/form-data" method="post" id="form-carga">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <button id="btn-cargar-evidencia" type="submit" class="btn btn-primary ml-4 w-25"><i class = "fas fa-upload">
                                </i>Cargar</button>
                            </div>
                        </form> 
                    </div>
                            ...
                            <div class="card card-evidencias">
                                ...
                                <div class="card-footer text-center" id="btn-ocultar">
                                    <form name="eliminar-ciudadano" method="POST" action="#" id="form-eliminar-evidencia">
                                        ...
                                        <input type="hidden" id="tipo_solicitud" value="individual">
                                        <button type="submit" class="btn btn-sm btn-danger boton-eliminar-evidencia" id="btn-eliminar-evidencia"><i class="fas fa-trash-alt"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "index.php?page=Detalles-solicitud-individual&id=<?= $_GET['id']; ?>&id_estado_solicitud=<?=$row['id_estado_solicitud']?>&evidencias=1";
                    });
                }
            });
        });
