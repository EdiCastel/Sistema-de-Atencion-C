<?php
    ...
    $sql2 = "SELECT nombre, apellido_paterno, apellido_materno FROM ciudadanos WHERE id_ciudadano = :id_ciudadano";
    $stmt2 = $conn->prepare($sql2);
    $stmt2 -> bindParam(':id_ciudadano', $row['id_ciudadano']);
    $stmt2 -> execute();
...
<div class="mb-4 ">
  <div class="container p-5">
      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col">
            <h5> <?= $row2['nombre'] . ' ' . $row2['apellido_paterno'] . ' ' . $row2['apellido_materno']?> </h5>
      ...
      <div class="">
        <h5>Para consultar el estado de la solicitud ingresa a: <a href="" class="link-underline-primary" >www.zentla.gob.mx/Solicitudes</a></h5>  
      </div><br>
      ...
      <div class="form-group d-flex justify-content-center"> 
        ...
        <button href="#" class="btn btn-success mr-5 w-25 d-print-none" type="button" id="btnSalirIn">
          Finalizar   
        </button>
      </div>
